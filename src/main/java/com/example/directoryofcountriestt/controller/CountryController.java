...
public class CountryController {
    ...
    @Operation(summary = "Get info about country",
            description = "As a user you have to give country name(in cyrillic or latin) or country code." +
                    "As a request you will get NOT_FOUND if we don't have info about this country" +
                    " or json about if we have information about the country.")
    @GetMapping
